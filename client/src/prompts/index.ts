...
export function capabilityAuditPrompt(evidence: EvidenceUnit[], draft: Capability): string {
  ...
  return [
    ...
    'FINALLY, compare the four dimensions against EACH OTHER and force them apart. People are rarely equally strong at',
    'all four — one or two are clearly strongest. If three or four are "advanced" you are almost certainly over-rating:',
    'keep advanced only for the dimension(s) with the most sophisticated, substantive evidence and lower the rest by at',
    'least one band. Be hardest on discernment and diligence — shallow reactions are not advanced. Audit domains too.',
