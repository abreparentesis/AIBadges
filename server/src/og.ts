...
export function renderBadgeSvg(content: StatBadgeContent): string {
  ...
  <text x="600" y="196" text-anchor="middle" font-family="Inter" font-size="19" letter-spacing="5" fill="${PURPLE}">AI FLUENCY CREDENTIAL</text>
  <text x="600" y="292" text-anchor="middle" font-family="Besley" font-size="76" font-weight="bold" fill="${INK}">AI Fluency - Stage ${stage}</text>
